...
<html>
    ...
    <body style="margin:0;background-image: url('<?php
        ...
        <form action="" method="post">
            <select style="padding:2px;border-radius:5px;margin: 8px 0;font-size:11px" id="filerR" name="filterd">
            ...
            <?php
                ...
                {   
                    if(isset($_POST['filter'])){
                        if($_POST['filter']=='Show All')
                        $reviews=mysqli_query($con,"select * from rnr where m_id=".$mid.";");
                        else
                        $reviews=mysqli_query($con,"select * from rnr where m_id=".$mid." and rating=".$_POST['filterd'].";");
                    }
                    else
                    {
                        $reviews=mysqli_query($con,"select * from rnr where m_id=".$mid.";");
